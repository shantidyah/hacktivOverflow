                ...
                <div class="card">
                    <div class="card-body row">
                        <div class="col-md-2 col-sm-2">
                            <i class="fas fa-caret-up fa-4x row" style="margin-left:35%; cursor:pointer"></i>
                            {{detailQuestion.vote}}
                            <i class="fas fa-caret-down fa-4x row" style="margin-left:35%; cursor:pointer"></i>
                        </div>
                        <div class="col-md-10 col-sm-10">
                            <div><p align="right" style="font-size:80%">asked {{detailQuestion.createdAt | changeDate}} by {{detailQuestion.user.name}}</p></div>
                            <div><p align="right" style="font-size:80%; color:blue"><a style="cursor:pointer">edit</a> | <a style="cursor:pointer">delete</a></p></div>

                            <div>{{detailQuestion.question}}</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="answer" style="margin-top:5%">
                ...
                <div class="card" v-for="(answer,index) in detailQuestion.answers" :key=index>
                    <div class="card-body row">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div><p align="right" style="font-size:80%">answered {{answer.createdAt | changeDate}} by {{answer.user}}</p></div>
                            <div><p align="right" style="font-size:80%; color:blue"><a style="cursor:pointer">edit</a></p></div>
